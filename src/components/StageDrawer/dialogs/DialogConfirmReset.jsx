...
function DialogConfirmReset({
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          This action will reset the editor to the initial state. If you want to
          save the current editor state for future editing, be sure to download
          it using the apposite screenshot button in the toolbar before
          proceeding.
        </DialogContentText>
      </DialogContent>
      <DialogActions>
